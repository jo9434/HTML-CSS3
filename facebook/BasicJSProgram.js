function notifyUser1()
{
    ...
    notifyUser1.style.height = "19px";
    notifyUser1.style.width = "22px";
    return notifyUser1;
}
...
function disableUser1()
{
    ...
    disableUser1.style.height = "15px";
    disableUser1.style.width = "15px";
    return disableUser1;
}
...
function notifyUser2()
{
    ...
    notifyUser2.style.height = "19px";
    notifyUser2.style.width = "22px";
    return notifyUser2;
}
...
function disableUser2()
{
    ...
    disableUser2.style.height = "15px";
    disableUser2.style.width = "15px";
    return disableUser2;
}
...
function notifyUser3()
{
    ...
    notifyUser3.style.height = "19px";
    notifyUser3.style.width = "22px";
    return notifyUser3;
}
...
function disableUser3()
{
    ...
    disableUser3.style.height = "15px";
